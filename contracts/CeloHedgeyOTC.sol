...
contract HedgeyOTC is ReentrancyGuard {
    ...
    */
     ...
     * @param min is the minimum amount of tokens that a buyer can purchase from you. this should be less than or equal to the total amount
    ...
    */
    function create(
        ...
        require((min * _price) / (10 ** Decimals(_token).decimals()) > 0, "HEC03: Minimum smaller than 0");
        /// @dev we check the before balance of this address for security
        ...
        /// @dev check the current balance now that the tokens should be in the contract address
    ...
    */    
     ...
     * @param amount is the amount of tokens the buyer is willing to purchase, which must be at least the minimumPurchase and at most the remainingAmount for this deal
    ...
    */
    ...
    function lockTokens(address _owner, address _token, uint _amount, uint _unlockDate) internal {
        ...
        /// @dev physically deliver the amount of tokens to the NFT contract address
